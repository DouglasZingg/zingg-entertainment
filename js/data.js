const projects = [
    ...
    {
        id: "shotgrid-mini-publisher",
        title: "Shotgrid Mini Publisher",
    ...
    {
        id: "texture-pack-validator",
        title: "Texture Pack Validator",
    ...
    {
        id: "studio-folder-builder",
        title: "Studio Folder Builder",
        summary: "A standalone Python + PySide6 tool that generates studio-style project folder structures from configurable templates.",
        tech: ["Python"],
    ...
    {
        id: "maya-asset-validator",
        title: "Maya Asset Validator",
    ...
    {
        id: "max-scene-cleaner",
        title: "Max Scene Cleaner",
    ...
    {
        id: "ue-asset-prep-tool",
        title: "UE Asset Prep Tool",
        summary: "Production-style pipeline utility for cleaning and validating 3ds Max scenes before export/hand-off.",
        tech: ["Python", "Max"],
